...
public class Controller26 {
    ...
    public void method1() throws SQLException {
        ...
        try (connection; statement) {
            ...
            statement.setTimestamp(5, Timestamp.valueOf(LocalDate.now().atStartOfDay()));
        }
    }
    ...
    public void method2() throws SQLException {
        ...
        try (connection; statement; resultSet) {
            if(resultSet.next()) {
                ...
                LocalDate dateCol = resultSet.getTimestamp("data_col").toLocalDateTime().toLocalDate();
