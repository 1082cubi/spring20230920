...
public class Controller23 {
    ...
    @GetMapping("sub2")
    public void method2(@RequestParam(value = "k", defaultValue = "") String key, Model model) throws SQLException {
        String sql = """
...
//                System.out.println("name = " + name);
    ...
    public void method3(@RequestParam(value = "st", defaultValue = "name1") String searchType,
                        @RequestParam(value = "k", defaultValue = "") String keyword, Model model)
            throws SQLException {
        String sql = """
